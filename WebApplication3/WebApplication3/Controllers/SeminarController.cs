...
namespace WebApplication3.Controllers
{
    public class SeminarController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="ID,Name,Date,Price,Slot")] Seminar seminar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ID,Name,Date,Price,Slot")] Seminar seminar)
        {
            if (ModelState.IsValid)
            {
