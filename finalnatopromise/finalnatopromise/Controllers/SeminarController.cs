...
namespace finalnatopromise.Controllers
{
    public class SeminarController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="SeminarID,Title,Price,SeminarDate")] Seminar seminar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="SeminarID,Title,Price,SeminarDate")] Seminar seminar)
        {
            if (ModelState.IsValid)
            {
